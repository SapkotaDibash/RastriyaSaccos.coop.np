...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    init_index2();
    init_stores();
    logo = "/_app/immutable/assets/logo-e14ddeea.png";
    css$1 = {
      code: ".visible_mobile.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{touch-action:none}header.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:flex;justify-content:space-between;position:sticky;top:0;opacity:100;background-color:#4075a6}.corner.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{width:3em;height:3em}.HAMBURGER.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{width:3em;height:3em;background:none;border:none;display:none;z-index:2;position:relative}nav.info-container-mobile.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:none;justify-content:center;--background:rgba(255, 255, 255, 0.7)}.corner.svelte-qwy3mn img.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{width:100%;height:100%;object-fit:contain}nav.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:flex;justify-content:center;--background:rgba(255, 255, 255, 0.7)}svg.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{width:2em;height:3em;display:block}path.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{fill:var(--background)}ul.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{position:relative;padding:0;margin:0;height:3em;display:flex;justify-content:center;align-items:center;list-style:none;background:var(--background);background-size:contain}li.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{position:relative;height:100%}li[aria-current='page'].svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn::before{--size:6px;content:'';width:0;height:0;position:absolute;top:0;left:calc(50% - var(--size));border:var(--size) solid transparent;border-top:var(--size) solid var(--color-theme-1)}nav.svelte-qwy3mn a.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:flex;height:100%;align-items:center;padding:0 0.5rem;color:var(--color-text);font-weight:700;font-size:0.8rem;text-transform:uppercase;letter-spacing:0.1em;text-decoration:none;transition:color 0.2s linear}a.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn:hover{color:var(--color-theme-1)}@media only screen and (max-width: 600px){nav.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:none}.HAMBURGER.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:block}nav.info-container-mobile.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:inline-block}#APP_SUMMARRY.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{font-size:1.25rem}.HAMBURGER.svelte-qwy3mn>div.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{width:35px;height:5px;background-color:var(--color-text);margin:6px 0;cursor:pointer}.visible_mobile.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:block}#nav.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{position:fixed;top:0;bottom:0;left:0;right:0;z-index:1;background:#847676;padding:2rem;overflow:auto}.visible_mobile.svelte-qwy3mn>svg.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:none}.visible_mobile.svelte-qwy3mn>ul.svelte-qwy3mn.svelte-qwy3mn.svelte-qwy3mn{display:block;background:none}.visible_mobile.svelte-qwy3mn>ul.svelte-qwy3mn>li.svelte-qwy3mn.svelte-qwy3mn{background:none;padding:0;margin:0;height:40px}.visible_mobile.svelte-qwy3mn>ul.svelte-qwy3mn>li.svelte-qwy3mn>a.svelte-qwy3mn{height:40px}.visible_mobile.svelte-qwy3mn>ul.svelte-qwy3mn>li[aria-current='page'].svelte-qwy3mn.svelte-qwy3mn::before{top:20px;left:0}.visible_mobile.svelte-qwy3mn>ul.svelte-qwy3mn>li[aria-current='page'].svelte-qwy3mn>a.svelte-qwy3mn{color:var(--color-theme-1);margin-left:10px}}",
      map: null
    };
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_page();
      return `<header class="${"svelte-qwy3mn"}"><div class="${"corner svelte-qwy3mn"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-qwy3mn"}"></div>

	<nav class="${"info-container-mobile svelte-qwy3mn"}"><a id="${"APP_SUMMARRY"}" class="${"svelte-qwy3mn"}">Rastriya Saccos</a></nav>
	

	<nav id="${"nav"}" class="${"visible_mobile svelte-qwy3mn"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-qwy3mn"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-qwy3mn"}"></path></svg>
		<ul class="${"svelte-qwy3mn"}"><li${add_attribute("aria-current", $page.url.pathname === "/" ? "page" : void 0, 0)} class="${"svelte-qwy3mn"}"><a href="${"/"}" class="${"svelte-qwy3mn"}">Home</a></li>
			<li${add_attribute("aria-current", $page.url.pathname === "/about-us" ? "page" : void 0, 0)} class="${"svelte-qwy3mn"}"><a href="${"/about-us"}" class="${"svelte-qwy3mn"}">About-Us</a></li>
			
			<li${add_attribute(
        "aria-current",
        $page.url.pathname === "/interest-rates" ? "page" : void 0,
        0
      )} class="${"svelte-qwy3mn"}"><a href="${"/interest-rates"}" class="${"svelte-qwy3mn"}">interest</a></li></ul>
		<svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-qwy3mn"}"><path d="${"M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z"}" class="${"svelte-qwy3mn"}"></path></svg></nav>

	<div class="${"corner svelte-qwy3mn"}"><button type="${"button"}" class="${"HAMBURGER svelte-qwy3mn"}"><div class="${"svelte-qwy3mn"}"></div>
			<div class="${"svelte-qwy3mn"}"></div>
			<div class="${"svelte-qwy3mn"}"></div></button></div>
</header>`;
    });
    css = {
      code: "footer.svelte-1f3v2nz.svelte-1f3v2nz{position:sticky;bottom:0;background-color:#4075a6}.app.svelte-1f3v2nz.svelte-1f3v2nz{display:flex;flex-direction:column;min-height:100vh}main.svelte-1f3v2nz.svelte-1f3v2nz{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:64rem;margin:0 auto;box-sizing:border-box}footer.svelte-1f3v2nz.svelte-1f3v2nz{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:12px}footer.svelte-1f3v2nz a.svelte-1f3v2nz{font-weight:bold}@media(min-width: 480px){footer.svelte-1f3v2nz.svelte-1f3v2nz{padding:12px 0}}",
      map: null
    };
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css);
      $$unsubscribe_page();
      return `<div class="${"app svelte-1f3v2nz"}">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}

	<main class="${"svelte-1f3v2nz"}">${slots.default ? slots.default({}) : ``}</main>

	<footer class="${"svelte-1f3v2nz"}"><li${add_attribute("aria-current", $page.url.pathname === "/services" ? "page" : void 0, 0)}><a href="${"/services"}" class="${"svelte-1f3v2nz"}">Services</a></li></footer>
</div>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-d09a7911.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-d09a7911.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/chunks/stores-0767d92c.js", "_app/immutable/chunks/singletons-96aee34c.js", "_app/immutable/chunks/index-d0ec9029.js"];
    stylesheets = ["_app/immutable/assets/_layout-62ecf972.css"];
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/components/error.svelte-212064d3.js";
    imports2 = ["_app/immutable/components/error.svelte-212064d3.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/chunks/stores-0767d92c.js", "_app/immutable/chunks/singletons-96aee34c.js", "_app/immutable/chunks/index-d0ec9029.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var css$12, Counter, welcome, welcome_fallback, css2, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    welcome = "/_app/immutable/assets/svelte-welcome-c18bcf5a.webp";
    welcome_fallback = "/_app/immutable/assets/svelte-welcome-6c300099.png";
    css2 = {
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-a49c8453.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-a49c8453.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/chunks/index-d0ec9029.js", "_app/immutable/modules/pages/_page.js-dc85b7cd.js", "_app/immutable/chunks/_page-da46b06b.js"];
    stylesheets3 = ["_app/immutable/assets/_page-265a38f0.css"];
    fonts3 = [];
  }
});
...
// .svelte-kit/output/server/entries/pages/about-us/_page.js
var page_exports2 = {};
...
// .svelte-kit/output/server/entries/pages/about-us/_page.svelte.js
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file4 = "_app/immutable/components/pages/about-us/_page.svelte-0877902c.js";
    imports4 = ["_app/immutable/components/pages/about-us/_page.svelte-0877902c.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/modules/pages/about-us/_page.js-89c0195c.js", "_app/immutable/chunks/environment-9aa685ef.js", "_app/immutable/chunks/_page-189548d5.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/downloads/_page.js
var page_exports3 = {};
...
// .svelte-kit/output/server/entries/pages/downloads/_page.svelte.js
...
<div class="${"text-column"}">DOWNLOADS
</div>`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    file5 = "_app/immutable/components/pages/downloads/_page.svelte-2803119b.js";
    imports5 = ["_app/immutable/components/pages/downloads/_page.svelte-2803119b.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/modules/pages/downloads/_page.js-89c0195c.js", "_app/immutable/chunks/environment-9aa685ef.js", "_app/immutable/chunks/_page-0528fb04.js"];
    stylesheets5 = [];
    fonts5 = [];
  }
});

// .svelte-kit/output/server/entries/pages/interest-rates/_page.js
var page_exports4 = {};
...
// .svelte-kit/output/server/entries/pages/interest-rates/_page.svelte.js
...
<div class="${"text-column"}">INTEREST-RATES
</div>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    file6 = "_app/immutable/components/pages/interest-rates/_page.svelte-98071d1a.js";
    imports6 = ["_app/immutable/components/pages/interest-rates/_page.svelte-98071d1a.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/modules/pages/interest-rates/_page.js-89c0195c.js", "_app/immutable/chunks/environment-9aa685ef.js", "_app/immutable/chunks/_page-6a6e5f22.js"];
    stylesheets6 = [];
    fonts6 = [];
  }
});

// .svelte-kit/output/server/entries/pages/services/_page.js
var page_exports5 = {};
...
<div class="${"text-column"}">SERVICES
</div>`;
    });
  }
});
...
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    ...
    file7 = "_app/immutable/components/pages/services/_page.svelte-63692576.js";
    imports7 = ["_app/immutable/components/pages/services/_page.svelte-63692576.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/modules/pages/services/_page.js-89c0195c.js", "_app/immutable/chunks/environment-9aa685ef.js", "_app/immutable/chunks/_page-9c76c2d7.js"];
    stylesheets7 = [];
    fonts7 = [];
  }
});
...
async function load_data({
  ...
  const result = await node.universal.load.call(null, {
    ...
    route: event.route,
    fetch: create_universal_fetch(event, state, fetched, csr5, resolve_opts),
...
function create_universal_fetch(event, state, fetched, csr5, resolve_opts) {
...
var Csp = class {
   ...
   */
  constructor({ mode, directives, reportOnly }, { prerender: prerender6 }) {
    /** @readonly */
...
var manifest = {
  ...
  _: {
    entry: { "file": "_app/immutable/start-affa3614.js", "imports": ["_app/immutable/start-affa3614.js", "_app/immutable/chunks/index-12d19206.js", "_app/immutable/chunks/singletons-96aee34c.js", "_app/immutable/chunks/index-d0ec9029.js"], "stylesheets": [], "fonts": [] },
    nodes: [
...
var prerendered = /* @__PURE__ */ new Set(["/", "/about-us", "/downloads", "/interest-rates", "/services"]);
